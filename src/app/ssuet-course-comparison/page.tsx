            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className=" shadow-md rounded-lg p-6">
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li className="bg-slate-500">Discrete Structures</li>
                        <li className="bg-pink-700">Programming Fundamentals</li>
                        <li className="bg-blue-700">Programming Fundamentals – Lab</li>
                        <li className="bg-purple-700">Linear Algebra</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Islamic Studies /Ethical Behaviour</li>
                        <li className="bg-lime-800">Object Oriented Programming</li>
                        <li className="bg-lime-800">Object Oriented Programming – Lab</li>
                        <li>Calculus and Analytic Geometry</li>
                        <li className="bg-amber-500">Digital Logic Design</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li className="bg-rose-600">Artificial Intelligence</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Programming for AI – Lab</li>
                        <li className="bg-yellow-700">Computer Organization & Assembly Language</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li className="bg-cyan-600">Information Security – Lab</li>
                        <li>Machine Learning</li>
                        <li>Machine Learning – Lab</li>
                        <li>Advanced Statistics</li>
                        <li>Advanced Statistics – Lab</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Knowledge Representation and Reasoning – Lab</li>
                        <li>Artificial Neural Network and Deep Learning</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Parallel and Distributed Computing – Lab</li>
                ...
                <div className=" shadow-md rounded-lg p-6">
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Islamic Studies 2</li>
                        <li className="bg-pink-700">Programming Fundamentals T</li>
                        <li className="bg-blue-700">Programming Fundamentals L</li>
                        <li className="">Introduction to Calculus</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li className="bg-red-700">Applied Physics L</li>
                        <li className="bg-amber-700">Applied Physics T</li>
                        <li className="bg-teal-900">Introduction to Software Engineering T</li>
                        <li>Introduction to Calculus / Introduction to Algebra and Geometry</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Data Structures and Algorithm T</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li className="bg-lime-500">Introduction to Database Systems T</li>
                        <li className="bg-orange-600">Operating Systems L</li>
                        <li className="bg-orange-600">Operating Systems T</li>
                        <li>Probability and Statistics</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Software construction and Development</li>
                        <li>Human Computer Interaction</li>
                        <li>UNIVERSITY ELECTIVES-I</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>SE ELECTIVE-III</li>
                        <li>SE SUPPORTING – I</li>
                        <li>UNIVERSITY ELECTIVES-II</li>
                        <li className="bg-cyan-600">Information Security</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>HS- UNIVERSITY ELECTIVES-III</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>UNIVERSITY ELECTIVES-IV</li>
                        <li>Computing Professional Practices</li>
                    </ul>
                ...
                <div className=" shadow-md rounded-lg p-6">
                    ...
                    <h4 className='font-semibold my-2' >Semester 1</h4>
                        ...
                        <li className="bg-blue-700">Programming Fundamentals Lab</li>
                        <li className="bg-red-700">Applied Physics Lab</li>
                        <li>Introduction to Information & Communication Technologies</li>
                        <li className="bg-purple-700">Linear Algebra</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li className="bg-amber-500">Digital Logic Design Lab</li>
                        <li className="bg-amber-500">Digital Logic Design Theory</li>
                        <li className="bg-green-700">Functional English</li>
                        <li>Calculus & Analytical Geometry</li>
                    </ul>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li className="bg-lime-500">Database Systems Lab</li>
                        <li className="bg-lime-500">Database Systems</li>
                        <li className="bg-orange-600">Introduction to Operating Systems Lab</li>
                        <li className="bg-orange-600">Introduction to Operating Systems Theory</li>
                    ...
                    <ul className="list-disc pl-6 my-6">
                        ...
                        <li>Computer Networks Lab</li>
                        <li>Computer Networks Theory</li>
...
export default SSUETCourseComparison;
